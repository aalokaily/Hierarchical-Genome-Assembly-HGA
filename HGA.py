...
" -t       int       number of threads to be used for re-assembly step using SPAdes assembler default 1. We noticed problems in SPAdes multithreading, so we suggest specifying no more than 4 threads with this option.\n" + \
